"""MPU6050 register addresses, bitfield positions, and configuration constants.

All values use micropython.const() for compile-time optimisation.
Stripped the ``MPU6050_`` prefix so you can import and use them inside your
class as::
    ...
    class MPU6050:
        def who_am_i(self):
            return self._read_byte(RA_WHO_AM_I)
"""
...
# I2C address
# ---------------------------------------------------------------------------
MPU6050_ADDRESS_AD0_LOW  = const(0x68)  # address pin low (GND), default
MPU6050_ADDRESS_AD0_HIGH = const(0x69)  # address pin high (VCC)
MPU6050_DEFAULT_ADDRESS  = const(0x68)
...
# ---------------------------------------------------------------------------
# Self-test bitfield positions & lengths
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Interrupt mode / drive / latch / clear
# ---------------------------------------------------------------------------
